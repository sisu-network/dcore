...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, dcore.NotFound
...
// func (ec *Client) SyncProgress(ctx context.Context) (*dcore.SyncProgress, error) {
// 	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (dcore.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q dcore.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q dcore.FilterQuery, ch chan<- types.Log) (dcore.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q dcore.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg dcore.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
// func (ec *Client) PendingCallContract(ctx context.Context, msg dcore.CallMsg) ([]byte, error) {
// 	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg dcore.CallMsg) (uint64, error) {
...
func toCallArg(msg dcore.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
